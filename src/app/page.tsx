    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-3xl font-medium tracking-tight text-center text-foreground mb-8">Topics I Write About</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="group relative bg-background border border-gray-200 dark:border-gray-800 rounded-lg p-6 transition-all duration-200 hover:shadow-medium">
                  ...
                  <h3 className="text-xl font-medium text-foreground mb-2">DevOps Shenanigans</h3>
                ...
                <div className="group relative bg-background border border-gray-200 dark:border-gray-800 rounded-lg p-6 transition-all duration-200 hover:shadow-medium">
                  ...
                  <h3 className="text-xl font-medium text-foreground mb-2">Code That Builds Stuff</h3>
                ...
                <div className="group relative bg-background border border-gray-200 dark:border-gray-800 rounded-lg p-6 transition-all duration-200 hover:shadow-medium">
                  ...
                  <h3 className="text-xl font-medium text-foreground mb-2">AI & Robot Overlords</h3>
